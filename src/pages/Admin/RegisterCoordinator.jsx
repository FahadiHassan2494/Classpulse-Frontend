...
const RegisterCoordinator = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://localhost:7145/Auth/RegisterCoordinator",
        {
          userName: username,
          email,
          password,
      ...
      if (error.response?.status === 401) {
        ...
        setError(error.message || "Failed to register coordinator.");
      }
    }
  };
    ...
    <div className="d-flex" style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <div className="d-flex justify-content-center align-items-center flex-grow-1">
        <div style={{ maxWidth: "500px", width: "100%", padding: "20px" }}>
          <h2 className="mb-4 text-dark text-center">Register Coordinator</h2>
